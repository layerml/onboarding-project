...
def train_model(
        ...
        order_features_base: Featureset("order_features_trial",
                                        ["status","main_product_category","main_payment_type","days_between_estimate_actual_delivery","avg_product_name_length","avg_product_description_length","avg_product_photos_qty"]),
        order_high_level_features: Featureset("order_high_level_features_trial2",
                                              ["total_waiting","shipping_payment_perc","is_multi_items"])
) -> Any:
